...
const introduce: IIntroduce.Payload = {
  ...
  contents: [
    ...
    '',
    '7년간 기계,전자관련 분야의 프로그래밍 언어를 다룬 경험이 있으며, 여러가지 프로젝트 경험을 토대로 맡은일에 대한 책임감과 문제해결 능력이 우수한편이고, 의사소통 및 대인관계에 능한편입니다. 세상을 다양하게 보기위해 세계일주를 다녀왔고 새로운것에 대한 모험과 도전하는 것에 항상 흥미와 관심이 많습니다.    ',
    '',
