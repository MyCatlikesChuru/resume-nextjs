...
const introduce: IIntroduce.Payload = {
  ...
  contents: [
    ...
    {
      content:
        'REST API를 이용한 통신을 주로 사용하였고, GraphQL 사용 Spring Data JPA, Querydsl 라이브러리를 활용한 쿼리문 작성이 가능하고 주로 MySQL 데이터베이스에 접근하여 서비스로직에서 처리하는 로직 구현을 경험해보았습니다.',
    },
    {
      content:
    ...
    {
      content:
        '클린 코드와 객체 지향 설계를 고려하여 유지 보수성이 높은 코드를 작성하는 것을 중요하게 생각합니다. 다양한 관점과 클린 코드를 위해 프로젝트 코드리뷰와 피드백을 적극 반영하고 있으며, 동료 개발자들과 모각코 스터디를 활동하면서 목표를 공유하고 지속적 학습의 동기부여와 피드백을 주고받고있습니다.',
    },
    {
      content: '',
    },
